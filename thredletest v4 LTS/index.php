      ...
      <ul class="slides-container">
          <li class="text-left">
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-12">
                          <h1 class="m-b-20"><strong>Welcome To <br> Thredle</strong></h1>
  ...
  <div class="inside-container"> 
    ...
    <div class="row row-pad">
      <div class=" col-sm-6 col-md-3  our-spec">
        ...
        <h3> Quality Stitching</h3>
          <p>we commit to provide you well stitched order with work that has been passed to the hands several craftsman .</p>
        <div class="rd-btn">
      ...
      <div class=" col-sm-6 col-md-3  our-spec">
        <div class="text-center">
          ...
          <p>we at thredle believe to never run out of time ,when it comes to giving our orders. It is our duty  and responsibility to provide your order well on time without a hasal.</p>
        <div class="rd-btn">
          <button class="read-more"> read more</button>
        </div>
      </div>
      <div class="col-sm-6 col-md-3  our-spec">
        ...
        <h3 > 24/7 Support</h3>
          <p> In case you have any problems regarding alteration, fabric or design which is related to any order that you may be concerned about , kindly contact. We are always available to help you.</p>
        <div class="rd-btn">
          <button class="read-more"> read more</button>
        </div>
      </div>
      <div class="col-sm-6 col-md-3  our-spec">
        ...
        <p>If due to any issue  regarding the print, quality or the size is seen and it under our disclosure , can be returned within 3-7 days and you will receive the cashback on time.</p>
        <div class="rd-btn">
          <button class="read-more"> read more</button>
        </div>
      </div>
  ...
  <div class="inside-container">
    <div class="row capa-head">
        <div class="col-lg-5 vr-line">
          <div> 
             <h2> our <span class="capa">capabilities</span> for our <span class="print-shop">Thredle (the online boutique)</span> </h2>
          </div>
          ...
          <div id="wrapper" class="center">
              <svg class="progress blue noselect" data-progress="88" x="0px" y="0px" viewBox="-20 -20 120 120">
                ...
                <path class="fill" d="M5,40a35,35 0 1,0 70,0a35,35 0 1,0 -70,0" />
                    ...
                    <text class="text" x="0%" y="30%">Quality</text>
              </svg>
            </div>
      </div>
      <div class="col-sm-6 col-lg-3"> 
          <div id="wrapper" class="center">
              <svg class="progress blue noselect" data-progress="53" x="0px" y="0px" viewBox="-20 -20 120 120">
                ...
                <path class="fill" d="M5,40a35,35 0 1,0 70,0a35,35 0 1,0 -70,0" />              
                    ...
                    <text class="text" x="0%" y="30%">Our Reach</text>
              </svg>
            </div>
      </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
          <div class="contact-con"> 
            <h2> Suggestion/Survey help us improve.</h2>
          <p> If you have any suggestion please suggest we try our best to fullfil it. </p>
          <div class="contact-btn"> <a href="https://docs.google.com/forms/d/e/1FAIpQLScDwhmvA3m5Q_o7_zbc3iY6ybQDhsIJK7cAkGJN-dojkEYEng/viewform?usp=sf_link" class="contact" > Take Survey/suggestion</a> </div>
          <div><a href="tel:+(11)123 456 7890" class="tel-number"> +(91)8449856003</a></div>
